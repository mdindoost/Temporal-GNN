#!/bin/bash
# Setup verification environment and run PHASE 1

echo "🚀 Setting up TempAnom-GNN Paper Verification Environment"
echo "========================================================="

# Navigate to project directory
cd /home/md724/temporal-gnn-project/assess_paper_results
...
# Save the data verification script
echo "💾 Creating data verification script..."
cat > data_verification/ground_truth_analysis.py << 'EOF'
#!/usr/bin/env python3
"""
...
chmod +x data_verification/ground_truth_analysis.py

echo "✅ Data verification script created"

# Run PHASE 1 verification
echo ""
echo "🚀 RUNNING PHASE 1: DATA FOUNDATION VERIFICATION"
echo "================================================="
...
echo "📁 Results saved in: assess_paper_results/data_verification/"
echo ""
echo "🔄 NEXT: Review verification report and proceed to PHASE 2"
